...
namespace NotepadUWP
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void openButton_Click(object sender, RoutedEventArgs e)
        {
            if (textChanged)
            {
                MessageDialog overwriteDialog = new MessageDialog("You have unsaved changes.  Are you sure you want to load the new file?");
                ...
                if (result != null && result.Label == "No") return;
            }
            OpenFile();
        }
